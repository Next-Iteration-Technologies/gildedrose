...
2. **Before coding**: Reference [core-standards.md](code-guidelines/core-standards.md) and [java-springboot.md](code-guidelines/java-springboot.md) for principles
